...
其余 `changelog.v02*` 亮点 / 短 bullet 与 `changelog.next.*` 与 `src/i18n/{zh,zh-TW,en}.ts` 同步。当前条目：v0.2.37（2026-09-21）到 v0.2.26（2026-08-24）。页脚 `footer.changelog` 全站指向本站 `/changelog/`。
