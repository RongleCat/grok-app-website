...
export const zhTW: Record<MessageKey, string> = {
  ...
  "changelog.v0237.b1":
    "模型選單可選 Grok 4.7 和 Grok 4.7 Fast。CLI 列出 4.7 後，新對話預設用它。Fast 的 token 價格是兩倍。",
  "changelog.v0237.b2":
    "同一專案的新對話會帶上已新增的附加資料夾；從本場移除後，重連不會再加回去。",
  "changelog.v0237.b3":
    "刪除對話也會刪掉對應的 CLI 會話；封存只是在側欄裡隱藏這場對話。",
  "changelog.v0237.b4":
    "數學公式會再渲染。在 Mac 上滾到最新訊息後會停在那裡，思考塊摺疊後仍跟著最新回覆。",
  ...
  "changelog.v0235.b1":
    "多根工作區可為會話宣告附加資料夾，獨立模式可開寫。",
  "changelog.v0235.b2":
    "Google 登入改用共享 Cookie 視窗，關閉後重新整理內嵌頁。",
  "changelog.v0235.b3":
    "思考串流增高時短暫停頓後仍貼底跟隨；從底部慢慢上滑不再彈回。",
  "changelog.v0235.b4":
    "Windows 本機 PNG 不再誤報損壞；輸入 @/goal 不再變成失效檔案 chip。",
  ...
  "changelog.v0233.b1": "Windows 安裝版與綠色版重新隨 Release 發布。",
  "changelog.v0233.b2": "游標在訊息輸入框時，新建對話和設定快捷鍵也能用。",
  "changelog.v0233.b3":
    "Worktree 清理點確認會真正執行 prune，而不只是關掉對話框。",
  "changelog.v0233.b4":
    "發版門禁要求 macOS / Windows / Linux 安裝包齊全，缺任一平台會失敗。",
